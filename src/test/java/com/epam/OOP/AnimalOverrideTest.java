...
public class AnimalOverrideTest {
    ...
    public void classDogExists() {
        Assertions.assertDoesNotThrow(() -> Class.forName("com.epam.OOP.Dog"), "Class Dog does not exist");
    }
    ...
    public void classBirdExists() {
        Assertions.assertDoesNotThrow(() -> Class.forName("com.epam.OOP.Bird"), "Class Bird does not exist");
    }
